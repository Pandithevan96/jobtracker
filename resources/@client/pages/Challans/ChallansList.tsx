...
export const ChallansList: React.FC = () => {
  ...
  const [form, setForm] = useState({
    ...
    parent_challan_id: '',
    type: '1',
    purpose_of_movement: 'Sent for job work under Rule 55',
    vendor_dc_number: '',
    vehicle_number: '',
    eway_bill_number: '',
    driver_name: '',
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        parent_challan_id: form.parent_challan_id ? Number(form.parent_challan_id) : undefined,
        type: Number(form.type),
        purpose_of_movement: form.purpose_of_movement.trim() || undefined,
        vendor_dc_number: form.vendor_dc_number.trim() || undefined,
        ...
        transporter_id: form.transporter_id.trim() || undefined,
